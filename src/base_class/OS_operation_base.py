...
class os_operation_base(object):
    ...
    def reportAllFiles(self,path):
        ...
        for dirpath,dirnames,filenames in os.walk(path): #os.walk()返回的是一个生成器
            for file_name in filenames:
                file_fullpath=os.path.join(dirpath,file_name) #dirpath是一个动态全路径
    ...
    def query_alive(self,machine_queue,alive_machineQueue,dead_machineQueue):
        '''
